...
const RESUME_DIRECTORY = new URL("../public/resume/", import.meta.url),
  RESUME_SOURCE = new URL("https://raw.githubusercontent.com/krubenok/resume/main/resume.pdf"),
  RESUME_TARGET = new URL("resume.pdf", RESUME_DIRECTORY),
  response = await fetch(RESUME_SOURCE);
