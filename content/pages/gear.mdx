...
My Apple Watch has slowly become and essential part of my daily technology footprint. I started with an Apple Watch first generation which I effectively refer to as a _"Series 0"_ (Apple really is terrible at naming things sometimes...). I'm current using a Nike Sport Series 4 Apple Watch in 44mm. The Series 4 was when the Apple Watch really grew up and became a mature product for me. The increased screen size in the same footprint, great processor and excellent software update introduced with the new hardware really made it a much more compelling overall package. 

I am a firm believer that if you're getting an Apple Watch Sport, the silver aluminum finish is the way to go if only because it's much better looking with a wider variety of bands. That being said, I _rarely_ change from the knockoff **Link Bracelet** band I got off Amazon a years ago with my original Series 0. Yes, it's very heavy but I just love the way a metal link bracelet looks on my wrist and the design of the Apple link bracelet is without a doubt on of the best in the wider watch world, let alone the smart watch world. 

I also use the Apple Watch for fleep Tracking with the excellent Auto Sleep and Auto Wake apps. My Series 4 managed to hold enough of a charge for a full day after about 30 minutes on the charger so while I shower or get ready in the morning tends to do the job. 

## Homelab

This section will get _extra_ nerdy as I discuss the enterprise hardware that powers my homelab. This is not a recommendation for the vast majority of consumers as most of this is inappropriate for home use for some reason or another. For those who lab, this will no doubt be an interesting read!

### Networking

In general, my networking stack is based on Meraki 

#### Firewall

For my firewall, I currently us a Meraki MX67 with an advanced security license. I was able to buy this device under Meraki's employee purchase program while I was still an intern there like the rest of my Meraki equipment. It is _total_ overkill but I do enjoy the features it offers and it performs quite well for me. The MX67 features 450Mbps of throughput with all features enabled. The split tunneling and management interface are particularly useful to me. 