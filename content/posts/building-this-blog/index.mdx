...
> Update Dec. 28th, 2021: This blog has been updated to Gatsby v4. You can read about some of the other changes to the blog setup in the new version of this post [Building this Blog 2021](./building-this-blog-2021).
